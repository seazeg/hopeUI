var Hope_mobile_datepicker = function (config) {
    ...
    HopeMobileDatepicker.prototype = {
        ...
        init: function (config) {
            ...
            _this.wheel = getClass(_this.hopeMobDatepicker, "wheel");
            _this.slider = getClass(_this.hopeMobDatepicker, "selectContainer");
            _this.wheels = _this.hopeMobDatepicker.querySelector(".wheels");
            _this.liHeight = _this.hopeMobDatepicker.querySelector(
                "li"
            ).offsetHeight;
            _this.ensureBtn = _this.hopeMobDatepicker.querySelector(".ensure");
            _this.cancelBtn = _this.hopeMobDatepicker.querySelector(".cancel");
            _this.grayLayer = _this.hopeMobDatepicker.querySelector(
                ".grayLayer"
            );
            _this.popUp = _this.hopeMobDatepicker.querySelector(".content");
        ...
        setTitle: function (string) {
            ...
            _this.hopeMobDatepicker.querySelector(".title").innerHTML =
                _this.titleText;
        },
        ...
        setStyle: function (config) {
            ...
            if (config.titleColor) {
                _this.title = _this.hopeMobDatepicker.querySelector(".title");
                _this.title.style.color = config.titleColor;
            }
            if (config.textColor) {
                _this.panel = _this.hopeMobDatepicker.querySelector(".panel");
                _this.panel.style.color = config.textColor;
            }
            if (config.titleBgColor) {
                _this.btnBar = _this.hopeMobDatepicker.querySelector(".btnBar");
                _this.btnBar.style.backgroundColor = config.titleBgColor;
            }
            if (config.bgColor) {
                _this.panel = _this.hopeMobDatepicker.querySelector(".panel");
                _this.shadowMask = _this.hopeMobDatepicker.querySelector(
                    ".shadowMask"
                );
        ...
        show: function () {
            this.hopeMobDatepicker.classList.add("hope-mobile-datepicker-show");
        },
        ...
        renderWheels: function (wheelsData, cancelBtnText, ensureBtnText) {
            ...
            _this.hopeMobDatepicker = document.createElement("div");
            _this.hopeMobDatepicker.className = "hope-mobile-datepicker";
            _this.hopeMobDatepicker.innerHTML =
                ...
                "</div>" +
                "</div>";
            document.body.appendChild(_this.hopeMobDatepicker);
        ...
        addListenerLi: function (sliderIndex) {
            var _this = this;
            var curWheelLi = _this.slider[sliderIndex].getElementsByTagName(
                "li"
            );
        ...
        initCascade: function () {
            ...
            _this.displayJson.push(
                _this.generateArrData(_this.cascadeJsonData)
            );
        ...
        checkRange: function (index, posIndexArr) {
            ...
            for (var i = 0; i <= index; i++) {
                if (i == 0) resultNode = _this.cascadeJsonData[posIndexArr[0]];
                    ...
                    resultNode =
                        resultNode[_this.keyMap.childs][posIndexArr[i]];
                }
            }
        ...
        getValue: function () {
            ...
            if (_this.cascade) {
                ...
                for (var i = 0; i < _this.curDistance.length; i++) {
                    temp.push(
                        _this.wheelsData[i].data[
                            _this.getIndex(_this.curDistance[i])
                        ]
                    );
                }
            } else {
